...
- The seed DB name is `lurus_api` per the service SSOT (`2b-svc-newhub/CLAUDE.md`);
  some older runbooks said `newhub`. Confirm against the live `SQL_DSN` before
  running the default-tenant seed.
