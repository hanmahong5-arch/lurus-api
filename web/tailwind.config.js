...
export default {
  ...
  theme: {
    extend: {
      ...
      // Note: Colors are in 'extend' to preserve default Tailwind colors (white, black, gray, etc.)
      colors: {
      ...
      animation: {
        ...
        'ailurus-aurora-shift': 'ailurusAuroraShift 8s ease-in-out infinite',
        'ailurus-aurora-pulse': 'ailurusAuroraPulse 3s ease-in-out infinite',
        'ailurus-float': 'ailurusFloat 6s ease-in-out infinite',
        'ailurus-glow-pulse': 'ailurusGlowPulse 2.5s ease-in-out infinite',
      },
      keyframes: {
        ailurusFadeIn: {
          '0%': { opacity: '0' },
        ...
        ailurusGlowPulse: {
          ...
          '50%': { boxShadow: '0 0 40px rgba(6, 182, 212, 0.5), 0 0 60px rgba(139, 92, 246, 0.3)' },
        },
      },
      ...
      backgroundImage: {
        ...
        // Signature three-color gradient (Teal → Purple → Rust)
        'ailurus-aurora': 'linear-gradient(135deg, #06B6D4 0%, #8B5CF6 50%, #C25E00 100%)',
        'ailurus-aurora-horizontal': 'linear-gradient(90deg, #06B6D4 0%, #8B5CF6 50%, #C25E00 100%)',
        'ailurus-aurora-vertical': 'linear-gradient(180deg, #06B6D4 0%, #8B5CF6 50%, #C25E00 100%)',
        'ailurus-aurora-radial': 'radial-gradient(ellipse at center, #8B5CF6 0%, #06B6D4 50%, #C25E00 100%)',
        'ailurus-aurora-soft': 'linear-gradient(135deg, rgba(6,182,212,0.8) 0%, rgba(139,92,246,0.8) 50%, rgba(194,94,0,0.8) 100%)',
        // Aurora text gradient (for gradient text effects)
        'ailurus-aurora-text': 'linear-gradient(135deg, #06B6D4 0%, #8B5CF6 40%, #C25E00 100%)',
        // Hero section animated gradient
        'ailurus-aurora-animated': 'linear-gradient(135deg, #06B6D4, #8B5CF6, #C25E00, #8B5CF6, #06B6D4)',
        // Shimmer effect background
        'ailurus-shimmer': 'linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.1) 50%, transparent 100%)',
        // Organic bubble gradients (for decorative elements)
        'ailurus-bubble-teal': 'radial-gradient(circle, rgba(6,182,212,0.4) 0%, transparent 70%)',
        'ailurus-bubble-purple': 'radial-gradient(circle, rgba(139,92,246,0.4) 0%, transparent 70%)',
        'ailurus-bubble-rust': 'radial-gradient(circle, rgba(194,94,0,0.4) 0%, transparent 70%)',
      },
