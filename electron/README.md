# Lurus API Electron Desktop App

This directory contains the Electron wrapper for Lurus API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., lurus-api-macos)
cp ../lurus-api-macos ../lurus-api
```
...
- Store database in `../data/lurus-api.db`
...
### Database Location
- **Development**: `../data/lurus-api.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Lurus API/data/`
  - Windows: `%APPDATA%/Lurus API/data/`
  - Linux: `~/.config/Lurus API/data/`
